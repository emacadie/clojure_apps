...
(deftest test-convert-media-links
  (testing "Converting media links"
      (def tweet-map-05 (edn/read-string (slurp "test/twitter_retriever/tweet-map-05.edn")))
      (def result-string (str "London-Shanghai stock link moves closer to reality https://t.co/PMGGfSI1mW "
                              "<a href=\"https://pbs.twimg.com/media/Ddr7IsLVwAAa_Jh.jpg\">https://t.co/kFY3YhDNoK</a>"))
      (is (= 0 (compare result-string (convert-media-links (:text tweet-map-05) tweet-map-05))))
)
)
